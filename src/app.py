...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and tournaments for basketball enthusiasts",
    ...
    "Debate Team": {
        "description": "Practice persuasive speaking and participate in debate competitions",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["ava.k@mergington.edu", "sophia.m@mergington.edu"]
    },
    "Robotics Club": {
